function hybrid_colors(alpha = 1.0)
    colors = [
        RGB(0.0, 0.0, 0.0), RGB(0.082, 0.643, 0.918), RGB(0.91, 0.122, 0.361),
        RGB(0.929, 0.773, 0.0), RGB(0.588, 0.196, 0.722), RGB(0.361, 0.722, 0.361),
        RGB(0.522, 0.522, 0.522),
    ]
    return @. RGBAf(red(colors), green(colors), blue(colors), alpha)
end
...
function theme_easy_hybrid()
    ...
    return Theme(
        ...
        size = (600, 400),
        palette = (
            color = my_colors, marker = my_markers, linestyle = my_linestyle,
