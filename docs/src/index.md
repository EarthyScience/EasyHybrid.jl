...
features:
  ...
  - title: Seamless Data Handling
    details: Efficient data manipulation in pure Julia. <a href="https://github.com/JuliaData/DataFrames.jl" class="highlight-link">DataFrames.jl</a> supports tabular data, while <a href="https://github.com/rafaqz/DimensionalData.jl" class="highlight-link">DimensionalData.jl</a> and <a href="https://github.com/mcabbott/AxisKeys.jl" class="highlight-link">AxisKeys.jl</a> provide named multidimensional arrays with <a href="https://juliadiff.org" class="highlight-link">automatic differentiation</a>.
