...
features:
  ...
  - title: Seamless Data Handling
    details: Efficient data manipulation. <a href="https://github.com/JuliaData/DataFrames.jl" class="highlight-link" target="_blank" rel="noopener noreferrer">DataFrames.jl</a> for tabular data, while <a href="https://github.com/rafaqz/DimensionalData.jl" class="highlight-link" target="_blank" rel="noopener noreferrer">DimensionalData.jl</a> and <a href="https://github.com/mcabbott/AxisKeys.jl" class="highlight-link" target="_blank" rel="noopener noreferrer">AxisKeys.jl</a> provide named multidimensional arrays with <a href="https://juliadiff.org" class="highlight-link" target="_blank" rel="noopener noreferrer">automatic differentiation</a>.
